...
mad_out_dir = '/explore/nobackup/people/hrodenhi/rts_mapping/planet_processing_test/data/yg_train_regions/mad_output/mad_files/'
...
makemydir(out_dir)
lm_data_out = '/explore/nobackup/people/hrodenhi/rts_mapping/planet_processing_test/data/yg_train_regions/mad_output/linear_models.csv'
failed_files_out = '/explore/nobackup/people/hrodenhi/rts_mapping/planet_processing_test/data/yg_train_regions/mad_output/failed_files.csv'

# check for files that have already been calibrated or failed
...
for tgt_file in tgt_files[0:5]:
    ...
    ref_path = [file for file in ref_files if re.match('.*' + 'N_' + polygon_id + '.tif$', file)]
    if len(ref_path) > 1:
