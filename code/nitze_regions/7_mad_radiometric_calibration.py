...
# Read in data
tgt_dir = '/explore/nobackup/people/hrodenhi/rts_mapping/planet_processing_test/data/nitze_regions/arosics_output/calibrated_files/'
tgt_files = []
...
ref_dir = '/explore/nobackup/people/hrodenhi/rts_mapping/planet_processing_test/data/sentinel_data/nitze_regions/'
ref_files = []
...
mad_out_dir = '/explore/nobackup/people/hrodenhi/rts_mapping/planet_processing_test/data/nitze_regions/mad_output/mad_files/'
makemydir(mad_out_dir)
out_dir = '/explore/nobackup/people/hrodenhi/rts_mapping/planet_processing_test/data/nitze_regions/mad_output/calibrated_files/'
makemydir(out_dir)
lm_data_out = '/explore/nobackup/people/hrodenhi/rts_mapping/planet_processing_test/data/nitze_regions/mad_output/linear_models.csv'
...
for tgt_file in tgt_files[0:5]:
    ...
    mad_output = mad_output.astype('uint16')
