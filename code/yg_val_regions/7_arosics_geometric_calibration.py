...
base_dir = '/explore/nobackup/people/hrodenhi/rts_mapping/planet_processing_test/data/yg_val_regions/planet_data'
ref_files = []
...
for tgt_file, udm_file in zip(tgt_files[start_idx:], udm_files[start_idx:]):
    ...
    if tgt_file.split('/')[-1].split('.')[0] not in calibrated:
        ...
        # /explore/nobackup/people/hrodenhi/rts_mapping/planet_processing_test/data/yg_val_regions/planet_data/region_x/unique_id/PSScene/file.tif
