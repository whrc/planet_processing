...
# Read in data
ref_dir = '/explore/nobackup/people/hrodenhi/rts_mapping/planet_processing_test/data/sentinel_data/yg_val_regions'
base_dir = '/explore/nobackup/people/hrodenhi/rts_mapping/planet_processing_test/data/planet_data/yg_val_regions'
ref_files = []
...
mask_dir = '/explore/nobackup/people/hrodenhi/rts_mapping/planet_processing_test/data/yg_val_regions/arosics_output/masked_files/'
makemydir(mask_dir)
out_dir = '/explore/nobackup/people/hrodenhi/rts_mapping/planet_processing_test/data/yg_val_regions/arosics_output/calibrated_files/'
makemydir(out_dir)
out_fig_dir = '/explore/nobackup/people/hrodenhi/rts_mapping/planet_processing_test/data/yg_val_regions/arosics_output/figures/'
...
for tgt_file, udm_file in zip(tgt_files[start_idx:], udm_files[start_idx:]):
    ...
    masked = os.listdir('/explore/nobackup/people/hrodenhi/rts_mapping/planet_processing_test/data/yg_val_regions/arosics_output/masked_files/')
    ...
    calibrated = os.listdir('/explore/nobackup/people/hrodenhi/rts_mapping/planet_processing_test/data/yg_val_regions/arosics_output/calibrated_files/')
    ...
    if tgt_file.split('/')[-1].split('.')[0] not in calibrated:
        ...
        # /explore/nobackup/people/hrodenhi/rts_mapping/planet_processing_test/data/planet_data/yg_val_regions/region_x/unique_id/PSScene/file.tif
...
masked_files = []
for root, subdirs, files in os.walk('/explore/nobackup/people/hrodenhi/rts_mapping/planet_processing_test/data/yg_val_regions/arosics_output/masked_files/'):
    for file in files:
